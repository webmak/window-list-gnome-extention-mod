...
const WindowList = new Lang.Class({
    ...
    _updatePosition: function() {
        ...
        this.actor.set_position(monitor.x, monitor.y +25);
    },
    ...
    _updateKeyboardAnchor: function() {
        ...
        let anchorY = Main.overview.visible ? 0 : 0;
	...
	return;
        ...
        let anchorY = this.actor.visible && sameMonitor ? 0 : 0;
...
let focused = false;
function init() {
	Main.panel.actor.connect('enter-event', function(){
		if (!windowList)
		 	windowList = new WindowList();
		Mainloop.timeout_add(15000, function () { disable(); });
	});
